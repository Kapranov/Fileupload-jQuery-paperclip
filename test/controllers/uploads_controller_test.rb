...
class UploadsControllerTest < ActionController::TestCase
  ...
  test "should update upload" do
    patch :update, id: @upload, upload: { upload_content_type: @upload.upload_content_type, upload_file_name: @upload.upload_file_name, upload_file_size: @upload.upload_file_size, upload_updated_at: @upload.upload_updated_at }
    assert_redirected_to upload_path(assigns(:upload))
  end
